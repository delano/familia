...
begin
  ...
  e.message.include?('No encryption keys configured')
end
#=> true
...
begin
  @model.secret
  false
rescue ArgumentError, Familia::EncryptionError
  true
end
#=> true
...
begin
  ...
  e.message.include?('No current key version set')
end
#=> true
...
begin
  ...
  e.message.include?('No key for version: nonexistent')
end
#=> true
