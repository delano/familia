# try/validation/atomic_operations_try.rb
...
commands = []
commands << CommandRecorder::RecordedCommand.new(
...
sequence = CommandRecorder::CommandSequence.new
commands.each { |cmd| sequence.add_command(cmd) }

atomicity_validator = AtomicityValidator.new(sequence)
...
result = AtomicityValidator.new(sequence).validate
